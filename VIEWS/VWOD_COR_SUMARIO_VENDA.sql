...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "CORRET"."VWOD_COR_SUMARIO_VENDA" ("CD_EMPRESA", "EMP_DCMS", "TOT_VIDAS", "VALOR_TOTAL", "CD_FORCA_VENDA", "NOME_FORCA", "CPF", "CD_CORRETORA", "NOME_CORRETORA", "CNPJ", "DT_VENDA", "TIPO_VENDA") AS 
  SELECT ''                                  AS cd_empresa, 
       ''                                  AS emp_dcms, 
