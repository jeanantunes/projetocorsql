...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "CORRET"."VWOD_EMP_TOTAL_VIDAS_PME" ("DT_VENDA", "CNPJ_CORRETORA", "CORRETORA", "CPF", "VENDEDOR", "CNPJ_CLIENTE", "RAZAO_SOCIAL_CLIENTE", "LOGIN_DCMS", "LOGRADOURO", "NUMERO", "COMPLEMENTO", "BAIRRO", "CIDADE", "UF", "CEP", "REPRESENTANTE_LEGAL", "CELULAR", "EMAIL", "PLANO", "TOTAL_VIDAS", "DIA_FATURA") AS 
  SELECT
    venda.dt_venda,
